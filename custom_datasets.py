...
class SummarizationDataset(Dataset):
    ...
    def collate_fn(self, batch):
        ...
        src_token = self.tokenizer(src, return_tensors="pt", padding=True, truncation=True, max_length=1020)
        tgt_token = self.tokenizer(tgt, return_tensors="pt", padding=True, truncation=True, max_length=1020)
