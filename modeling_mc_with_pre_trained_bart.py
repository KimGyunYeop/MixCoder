...
class BartDecoderLayer(nn.Module):
    def __init__(self, config: BartConfig):
        ...
        if config.share_self_attention_module:
            ...
            self.next_token_self_attn = BART_ATTENTION_CLASSES[config._attn_implementation](
                embed_dim=self.embed_dim,
                num_heads=config.decoder_attention_heads,
                dropout=config.attention_dropout,
                is_decoder=True,
        ...
        if config.pass_hidden_to_cross_att:
            if config.share_cross_attention_module:
                ...
                self.cur_token_encoder_attn = BART_ATTENTION_CLASSES[config._attn_implementation](
                    self.embed_dim,
                    config.decoder_attention_heads,
                    dropout=config.attention_dropout,
                    is_decoder=True,
