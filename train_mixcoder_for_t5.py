...
with torch.no_grad():
    ...
    for batch in tqdm(test_dataloader):
        ...
        out = model.generate(input_ids=batch["input_ids"], attention_mask=batch["attention_mask"], use_cache=False, num_beams=args.num_beam, do_sample=True, max_new_tokens=512, length_penalty=0.6)
        print(out)
